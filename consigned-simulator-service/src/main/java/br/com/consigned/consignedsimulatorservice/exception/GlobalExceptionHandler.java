...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InstallmentsLimitExceededException.class)
    public ResponseEntity<Object> handleInstallmentsLimitExceededException(InstallmentsLimitExceededException e) {
